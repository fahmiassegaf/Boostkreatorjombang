    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 h-[72px] flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <Link href="#alur" className="text-[14px] text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] transition-colors">Kurikulum</Link>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-8">
              <Link href="#program" onClick={() => setIsOpen(false)} className="text-[32px] font-medium text-[var(--color-text-main)] tracking-[-1px] border-b border-[var(--color-border)] pb-4">Program</Link>
              <Link href="#alur" onClick={() => setIsOpen(false)} className="text-[32px] font-medium text-[var(--color-text-main)] tracking-[-1px] border-b border-[var(--color-border)] pb-4">Kurikulum</Link>
              <Link href="#faq" onClick={() => setIsOpen(false)} className="text-[32px] font-medium text-[var(--color-text-main)] tracking-[-1px] border-b border-[var(--color-border)] pb-4">FAQ</Link>
